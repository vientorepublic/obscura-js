 ...
 *   }
 */
export function applyControlFlowFlattening(ast: t.File, options: ControlFlowFlatteningOptions = {}): void {
    ...
    traverse(ast, {
      Function(path) {
        ...
        const cases = body.map((stmt, idx) => {
          ...
          return t.switchCase(t.numericLiteral(idx), [
        ...
        path.node.body = t.blockStatement([
          t.variableDeclaration("let", [t.variableDeclarator(t.identifier(stateVar), t.numericLiteral(0))]),
          dispatcher,
        ]);
